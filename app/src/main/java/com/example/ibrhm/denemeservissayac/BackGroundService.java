...
public class BackGroundService extends Service {
    ...
    public class MyLocationListener implements LocationListener {
        public void onLocationChanged(Location loc) {
            ...
            if (BackGroundService.this.isBetterLocation(loc, BackGroundService.this.previousBestLocation)) {
                loc.getLatitude();
                loc.getLongitude();
                Toast.makeText(BackGroundService.this.context, "Latitude" + loc.getLatitude() + "\nLongitude" + loc.getLongitude(),Toast.LENGTH_LONG).show();
        ...
        public void onProviderDisabled(String provider) {
            Toast.makeText(BackGroundService.this.getApplicationContext(), "Gps Disabled", Toast.LENGTH_SHORT).show();
        }

        public void onProviderEnabled(String provider) {
            Toast.makeText(BackGroundService.this.getApplicationContext(), "Gps Enabled", Toast.LENGTH_SHORT).show();
        }
